...
- Parkiroid is a Kotlin Android app for background parked-vehicle monitoring (rear-camera photos, battery telemetry, cloud object detection via server uploads)
